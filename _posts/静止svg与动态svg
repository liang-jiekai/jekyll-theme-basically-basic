...
.card-icon svg{
position: center;
animation: my first 10s infinite;}
div.card-icon
{
	width:400px;
	height:300px;
	transition:roate(180deg)
	-webkit-transition:roate(180deg)
...
@keyframes myfirst{
    ...
    -webkit-animation-direction: left:0px; top:0px;
	}
	5%,15%,25%{
		-webkit-transform: rotate(360deg);
    -webkit-animation-direction: left:200px; top:200px;
	}
	0%,30%,100%{
		-webkit-transform: rotate(018deg);
    -webkit-animation-direction: left:0px; top:0px;
    }
